    ...
    <b-container class="no-print">
      <b-row>
        ...
        <b-col>
          ...
          <b-form-textarea
            v-model="licenseMapText"
            placeholder="13CAP-00000034,bob"
            rows="3"
          ></b-form-textarea>
        </b-col>
        <b-col>
        ...
        <b-tabs>
          <b-tab title="Standard" active>
            ...
            <b-row v-for="(r, i) in dcra" :key="i">
              ...
              <b-col class="table-item" :class="{ even: (i%2)==0 }" v-for="(s, j) in r.spots" :key="j">{{ s }}</b-col>
            </b-row>
          </b-tab>
          <b-tab title="Day of Week">
            ...
            <b-row v-for="(r, i) in dcra2" :key="i" :class="{ 'page-break': (i<(dcra2.length-1) && dcra2[i].day!=dcra2[i+1].day) }">
